...
public class TP5 {
    ...
    public static class MonProgMapper
            extends Mapper<Object, Text, NullWritable, VilleWritable> {
        ...
        public void map(Object key, Text value, Context context
            ...
            if (!(tokens[4].isEmpty()) & !tokens[4].equals("Population")) {
                topKVilles.put(Float.parseFloat(tokens[4]), new VilleWritable(Float.parseFloat(tokens[4]), value.toString()));
            }
    ...
    public static class MonProgCombiner
            extends Reducer<NullWritable, VilleWritable, NullWritable, VilleWritable>{
        public int k = 0;
        private TreeMap<Float, VilleWritable> topKVilles = new TreeMap<Float, VilleWritable>();
